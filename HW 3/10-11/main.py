...
if __name__ == "__main__":
    ...
    foodname2 = FoodItem(namename, amount_fat, amount_carbs, amount_protein)
    ...
    foodname2.print_info()
    print('Number of calories for {:.2f} serving(s): {:.2f}'.format(num_servings, foodname2.get_calories(num_servings)))